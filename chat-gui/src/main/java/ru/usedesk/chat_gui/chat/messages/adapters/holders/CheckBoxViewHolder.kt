...
internal class CheckBoxViewHolder(
    ...
    private val checkedDrawable = binding.styleValues.getId(commonR.attr.usedesk_drawable_1)
    private val uncheckedDrawable = binding.styleValues.getId(commonR.attr.usedesk_drawable_2)
    private val checkedDisabledDrawable = binding.styleValues.getId(commonR.attr.usedesk_drawable_3)
    private val uncheckedErrorDrawable = binding.styleValues.getId(commonR.attr.usedesk_drawable_4)
