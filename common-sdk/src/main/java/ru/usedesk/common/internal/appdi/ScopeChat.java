...
import ru.usedesk.sdk.internal.domain.interactor.ChatInteractorRx;
...
public class ScopeChat extends DependencyInjection {
    ...
    protected Module getModule(final Context appContext) {
        return new Module() {{
            ...
            bind(ChatInteractor.class).to(ChatInteractor.class).singleton();
            bind(UsedeskChatSdk.class).to(ChatInteractor.class).singleton();
            bind(IUsedeskChatRx.class).to(ChatInteractorRx.class).singleton();
            ...
            bind(IKnowledgeBaseInteractor.class).to(KnowledgeBaseInteractor.class).singleton();

            bind(IKnowledgeBaseRepository.class).to(KnowledgeBaseRepository.class).singleton();

            bind(IApiLoader.class).to(ApiLoader.class).singleton();
