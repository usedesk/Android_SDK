...
internal interface IKnowledgeBaseApiRepository {
    fun getSections(accountId: String,
                    token: String): List<UsedeskSection>

    fun getCategories(accountId: String,
                      token: String,
                      sectionId: Long): List<UsedeskCategory>

    fun getArticles(accountId: String,
                    token: String,
                    categoryId: Long): List<UsedeskArticleInfo>

    fun getArticle(accountId: String,
                   token: String,
    ...
    fun addViews(accountId: String,
                 token: String,
                 articleId: Long)

    fun sendRating(accountId: String,
                   token: String,
                   articleId: Long,
                   good: Boolean)
