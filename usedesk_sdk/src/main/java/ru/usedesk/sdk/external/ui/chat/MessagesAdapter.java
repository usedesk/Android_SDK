...
public class MessagesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_USER_TEXT:
                return new ItemUserTextMessageHolder(layoutInflater, parent);
            case TYPE_USER_FILE:
                return new ItemUserFileMessageHolder(layoutInflater, parent);
            case TYPE_USER_TEXT_FILE:
                return new ItemUserTextFileMessageHolder(layoutInflater, parent);
            case TYPE_OPERATOR_TEXT:
                return new ItemOperatorTextMessageHolder(layoutInflater, parent);
            case TYPE_OPERATOR_TEXT_FILE:
                return new ItemOperatorTextFileMessageHolder(layoutInflater, parent);
            case TYPE_OPERATOR_FILE:
                return new ItemOperatorFileMessageHolder(layoutInflater, parent);
            case TYPE_OPERATOR_FEEDBACK:
                return new ItemOperatorFeedbackMessageHolder(layoutInflater, parent);
            case TYPE_SERVICE_TEXT:
            default:
                return new ItemServiceTextMessageHolder(layoutInflater, parent);
        }
    }
    ...
    private class ItemOperatorFeedbackMessageHolder extends MessageHolder {
        ...
        ItemOperatorFeedbackMessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
            super(layoutInflater, viewGroup, R.layout.usedesk_item_message_operator_feedback);
    ...
    private class ItemUserTextMessageHolder extends TextMessageHolder {
        ...
        ItemUserTextMessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
            super(layoutInflater, viewGroup, R.layout.usedesk_item_message_user_text);
        }
    ...
    private class ItemOperatorTextMessageHolder extends TextMessageHolder {
        ...
        public ItemOperatorTextMessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
            super(layoutInflater, viewGroup, R.layout.usedesk_item_message_operator_text);
    ...
    private class ItemServiceTextMessageHolder extends TextMessageHolder {
        ...
        ItemServiceTextMessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
            super(layoutInflater, viewGroup, R.layout.usedesk_item_message_service_text);
        }
    ...
    private abstract class TextMessageHolder extends MessageHolder {
        ...
        TextMessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup, int id) {
            super(layoutInflater, viewGroup, id);
    ...
    private class ItemUserFileMessageHolder extends FileMessageHolder {
        ...
        ItemUserFileMessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
            super(layoutInflater, viewGroup, R.layout.usedesk_item_message_user_file);
        }
    ...
    private class ItemOperatorFileMessageHolder extends FileMessageHolder {
        ...
        ItemOperatorFileMessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
            super(layoutInflater, viewGroup, R.layout.usedesk_item_message_operator_file);
    ...
    private abstract class FileMessageHolder extends MessageHolder {
        ...
        FileMessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup, int id) {
            super(layoutInflater, viewGroup, id);
    ...
    private class ItemUserTextFileMessageHolder extends TextFileMessageHolder {
        ItemUserTextFileMessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
            super(layoutInflater, viewGroup, R.layout.usedesk_item_message_user_text_file);
        }
    ...
    private class ItemOperatorTextFileMessageHolder extends TextFileMessageHolder {
        ...
        ItemOperatorTextFileMessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
            super(layoutInflater, viewGroup, R.layout.usedesk_item_message_operator_text_file);
    ...
    private abstract class TextFileMessageHolder extends MessageHolder {
        ...
        TextFileMessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup, int id) {
            super(layoutInflater, viewGroup, id);
    ...
    private abstract class MessageHolder extends RecyclerView.ViewHolder {
        ...
        MessageHolder(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup, int id) {
            super(layoutInflater.inflate(id, viewGroup, false));
